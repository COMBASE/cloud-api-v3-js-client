...
------------- | ------------- | -------------
[**getSector**](SectorsApi.md#getSector) | **GET** /accounts/{koronaAccountId}/sectors/{sectorId} | lists the sector
[**getSectors**](SectorsApi.md#getSectors) | **GET** /accounts/{koronaAccountId}/sectors | lists all sectors


<a name="getSector"></a>
# **getSector**
> Sector getSector(koronaAccountId, sectorId)
...
apiInstance.getSector(koronaAccountId, sectorId, callback);
```
