...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/DayRating'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./DayRating'));
  } else {
    // Browser globals (root is window)
    if (!root.CloudApiV3JsClient) {
      root.CloudApiV3JsClient = {};
    }
    root.CloudApiV3JsClient.ResultListDayRating = factory(root.CloudApiV3JsClient.ApiClient, root.CloudApiV3JsClient.DayRating);
  }
}(this, function(ApiClient, DayRating) {
  'use strict';
  ...
  /**
   * The ResultListDayRating model module.
   * @module model/ResultListDayRating
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>ResultListDayRating</code>.
   * @alias module:model/ResultListDayRating
   * @class
   ...
   * @param results {Array.<module:model/DayRating>} result list
  ...
  /**
   * Constructs a <code>ResultListDayRating</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ResultListDayRating} obj Optional instance to populate.
   * @return {module:model/ResultListDayRating} The populated <code>ResultListDayRating</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results')) {
        obj['results'] = ApiClient.convertToType(data['results'], [DayRating]);
      }
  ...
  /**
   * result list
   * @member {Array.<module:model/DayRating>} results
   */
