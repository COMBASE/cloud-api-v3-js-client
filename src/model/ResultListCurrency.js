...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CloudApiV3JsClient.ResultListCurrency = factory(root.CloudApiV3JsClient.ApiClient, root.CloudApiV3JsClient.Currency);
  }
  ...
  /**
   * The ResultListCurrency model module.
   * @module model/ResultListCurrency
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>ResultListCurrency</code>.
   * @alias module:model/ResultListCurrency
   * @class
   ...
   * @param results {Array.<module:model/Currency>} result list
  ...
  /**
   * Constructs a <code>ResultListCurrency</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ResultListCurrency} obj Optional instance to populate.
   * @return {module:model/ResultListCurrency} The populated <code>ResultListCurrency</code> instance.
   */
