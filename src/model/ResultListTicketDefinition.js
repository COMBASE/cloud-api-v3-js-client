...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/TicketDefinition'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TicketDefinition'));
  } else {
    // Browser globals (root is window)
    if (!root.CloudApiV3JsClient) {
      root.CloudApiV3JsClient = {};
    }
    root.CloudApiV3JsClient.ResultListTicketDefinition = factory(root.CloudApiV3JsClient.ApiClient, root.CloudApiV3JsClient.TicketDefinition);
  }
}(this, function(ApiClient, TicketDefinition) {
  'use strict';
  ...
  /**
   * The ResultListTicketDefinition model module.
   * @module model/ResultListTicketDefinition
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>ResultListTicketDefinition</code>.
   * @alias module:model/ResultListTicketDefinition
   * @class
   ...
   * @param results {Array.<module:model/TicketDefinition>} result list
  ...
  /**
   * Constructs a <code>ResultListTicketDefinition</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ResultListTicketDefinition} obj Optional instance to populate.
   * @return {module:model/ResultListTicketDefinition} The populated <code>ResultListTicketDefinition</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results')) {
        obj['results'] = ApiClient.convertToType(data['results'], [TicketDefinition]);
      }
  ...
  /**
   * result list
   * @member {Array.<module:model/TicketDefinition>} results
   */
