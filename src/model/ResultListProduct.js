...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CloudApiV3JsClient.ResultListProduct = factory(root.CloudApiV3JsClient.ApiClient, root.CloudApiV3JsClient.Product);
  }
  ...
  /**
   * The ResultListProduct model module.
   * @module model/ResultListProduct
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>ResultListProduct</code>.
   * @alias module:model/ResultListProduct
   * @class
   ...
   * @param results {Array.<module:model/Product>} result list
  ...
  /**
   * Constructs a <code>ResultListProduct</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ResultListProduct} obj Optional instance to populate.
   * @return {module:model/ResultListProduct} The populated <code>ResultListProduct</code> instance.
   */
