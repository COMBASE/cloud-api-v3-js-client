...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CloudApiV3JsClient.ResultListEvent = factory(root.CloudApiV3JsClient.ApiClient, root.CloudApiV3JsClient.Event);
  }
  ...
  /**
   * The ResultListEvent model module.
   * @module model/ResultListEvent
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>ResultListEvent</code>.
   * @alias module:model/ResultListEvent
   * @class
   ...
   * @param results {Array.<module:model/Event>} result list
  ...
  /**
   * Constructs a <code>ResultListEvent</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ResultListEvent} obj Optional instance to populate.
   * @return {module:model/ResultListEvent} The populated <code>ResultListEvent</code> instance.
   */
