...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Pos'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Pos'));
  } else {
    // Browser globals (root is window)
    if (!root.CloudApiV3JsClient) {
      root.CloudApiV3JsClient = {};
    }
    root.CloudApiV3JsClient.ResultListPos = factory(root.CloudApiV3JsClient.ApiClient, root.CloudApiV3JsClient.Pos);
  }
}(this, function(ApiClient, Pos) {
  'use strict';
  ...
  /**
   * The ResultListPos model module.
   * @module model/ResultListPos
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>ResultListPos</code>.
   * @alias module:model/ResultListPos
   * @class
   ...
   * @param results {Array.<module:model/Pos>} result list
  ...
  /**
   * Constructs a <code>ResultListPos</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ResultListPos} obj Optional instance to populate.
   * @return {module:model/ResultListPos} The populated <code>ResultListPos</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results')) {
        obj['results'] = ApiClient.convertToType(data['results'], [Pos]);
      }
  ...
  /**
   * result list
   * @member {Array.<module:model/Pos>} results
   */
