...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CloudApiV3JsClient.ResultListAccount = factory(root.CloudApiV3JsClient.ApiClient, root.CloudApiV3JsClient.Account);
  }
  ...
  /**
   * The ResultListAccount model module.
   * @module model/ResultListAccount
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>ResultListAccount</code>.
   * @alias module:model/ResultListAccount
   * @class
   ...
   * @param results {Array.<module:model/Account>} result list
  ...
  /**
   * Constructs a <code>ResultListAccount</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ResultListAccount} obj Optional instance to populate.
   * @return {module:model/ResultListAccount} The populated <code>ResultListAccount</code> instance.
   */
