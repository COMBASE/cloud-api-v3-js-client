...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ExternalSystemCall'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ExternalSystemCall'));
  } else {
    // Browser globals (root is window)
    if (!root.KoronacloudApiV3) {
      root.KoronacloudApiV3 = {};
    }
    root.KoronacloudApiV3.ResultListExternalSystemCall = factory(root.KoronacloudApiV3.ApiClient, root.KoronacloudApiV3.ExternalSystemCall);
  }
}(this, function(ApiClient, ExternalSystemCall) {
  'use strict';
  ...
  /**
   * The ResultListExternalSystemCall model module.
   * @module model/ResultListExternalSystemCall
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>ResultListExternalSystemCall</code>.
   * @alias module:model/ResultListExternalSystemCall
   * @class
   ...
   * @param results {Array.<module:model/ExternalSystemCall>} result list
  ...
  /**
   * Constructs a <code>ResultListExternalSystemCall</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ResultListExternalSystemCall} obj Optional instance to populate.
   * @return {module:model/ResultListExternalSystemCall} The populated <code>ResultListExternalSystemCall</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results')) {
        obj['results'] = ApiClient.convertToType(data['results'], [ExternalSystemCall]);
      }
  ...
  /**
   * result list
   * @member {Array.<module:model/ExternalSystemCall>} results
   */
