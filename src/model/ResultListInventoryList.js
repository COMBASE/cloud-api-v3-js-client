...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CloudApiV3JsClient.ResultListInventoryList = factory(root.CloudApiV3JsClient.ApiClient, root.CloudApiV3JsClient.InventoryList);
  }
  ...
  /**
   * The ResultListInventoryList model module.
   * @module model/ResultListInventoryList
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>ResultListInventoryList</code>.
   * @alias module:model/ResultListInventoryList
   * @class
   ...
   * @param results {Array.<module:model/InventoryList>} result list
  ...
  /**
   * Constructs a <code>ResultListInventoryList</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ResultListInventoryList} obj Optional instance to populate.
   * @return {module:model/ResultListInventoryList} The populated <code>ResultListInventoryList</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results')) {
        obj['results'] = ApiClient.convertToType(data['results'], [InventoryList]);
      }
  ...
  /**
   * result list
   * @member {Array.<module:model/InventoryList>} results
   */
