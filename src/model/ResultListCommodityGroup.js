...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CommodityGroup'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CommodityGroup'));
  } else {
    // Browser globals (root is window)
    if (!root.CloudApiV3JsClient) {
      root.CloudApiV3JsClient = {};
    }
    root.CloudApiV3JsClient.ResultListCommodityGroup = factory(root.CloudApiV3JsClient.ApiClient, root.CloudApiV3JsClient.CommodityGroup);
  }
}(this, function(ApiClient, CommodityGroup) {
  'use strict';
  ...
  /**
   * The ResultListCommodityGroup model module.
   * @module model/ResultListCommodityGroup
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>ResultListCommodityGroup</code>.
   * @alias module:model/ResultListCommodityGroup
   * @class
   ...
   * @param results {Array.<module:model/CommodityGroup>} result list
  ...
  /**
   * Constructs a <code>ResultListCommodityGroup</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ResultListCommodityGroup} obj Optional instance to populate.
   * @return {module:model/ResultListCommodityGroup} The populated <code>ResultListCommodityGroup</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results')) {
        obj['results'] = ApiClient.convertToType(data['results'], [CommodityGroup]);
      }
  ...
  /**
   * result list
   * @member {Array.<module:model/CommodityGroup>} results
   */
