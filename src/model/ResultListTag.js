...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CloudApiV3JsClient.ResultListTag = factory(root.CloudApiV3JsClient.ApiClient, root.CloudApiV3JsClient.Tag);
  }
  ...
  /**
   * The ResultListTag model module.
   * @module model/ResultListTag
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>ResultListTag</code>.
   * @alias module:model/ResultListTag
   * @class
   ...
   * @param results {Array.<module:model/Tag>} result list
  ...
  /**
   * Constructs a <code>ResultListTag</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ResultListTag} obj Optional instance to populate.
   * @return {module:model/ResultListTag} The populated <code>ResultListTag</code> instance.
   */
