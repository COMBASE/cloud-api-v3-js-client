...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CloudApiV3JsClient.ResultListCustomerGroup = factory(root.CloudApiV3JsClient.ApiClient, root.CloudApiV3JsClient.CustomerGroup);
  }
  ...
  /**
   * The ResultListCustomerGroup model module.
   * @module model/ResultListCustomerGroup
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>ResultListCustomerGroup</code>.
   * @alias module:model/ResultListCustomerGroup
   * @class
   ...
   * @param results {Array.<module:model/CustomerGroup>} result list
  ...
  /**
   * Constructs a <code>ResultListCustomerGroup</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ResultListCustomerGroup} obj Optional instance to populate.
   * @return {module:model/ResultListCustomerGroup} The populated <code>ResultListCustomerGroup</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results')) {
        obj['results'] = ApiClient.convertToType(data['results'], [CustomerGroup]);
      }
  ...
  /**
   * result list
   * @member {Array.<module:model/CustomerGroup>} results
   */
