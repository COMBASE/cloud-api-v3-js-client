...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CommodityGroupResource'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CommodityGroupResource'));
  } else {
    // Browser globals (root is window)
    if (!root.KoronacloudApiV3) {
      root.KoronacloudApiV3 = {};
    }
    root.KoronacloudApiV3.ResultListCommodityGroupResource = factory(root.KoronacloudApiV3.ApiClient, root.KoronacloudApiV3.CommodityGroupResource);
  }
}(this, function(ApiClient, CommodityGroupResource) {
  'use strict';
  ...
  /**
   * The ResultListCommodityGroupResource model module.
   * @module model/ResultListCommodityGroupResource
   * @version 3
   */

  /**
   * Constructs a new <code>ResultListCommodityGroupResource</code>.
   * @alias module:model/ResultListCommodityGroupResource
   * @class
   ...
   * @param results {Array.<module:model/CommodityGroupResource>} result list
  ...
  /**
   * Constructs a <code>ResultListCommodityGroupResource</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ResultListCommodityGroupResource} obj Optional instance to populate.
   * @return {module:model/ResultListCommodityGroupResource} The populated <code>ResultListCommodityGroupResource</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results')) {
        obj['results'] = ApiClient.convertToType(data['results'], [CommodityGroupResource]);
      }
  ...
  /**
   * result list
   * @member {Array.<module:model/CommodityGroupResource>} results
   */
