...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ProductStock'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ProductStock'));
  } else {
    // Browser globals (root is window)
    if (!root.CloudApiV3JsClient) {
      root.CloudApiV3JsClient = {};
    }
    root.CloudApiV3JsClient.ResultListProductStock = factory(root.CloudApiV3JsClient.ApiClient, root.CloudApiV3JsClient.ProductStock);
  }
}(this, function(ApiClient, ProductStock) {
  'use strict';
  ...
  /**
   * The ResultListProductStock model module.
   * @module model/ResultListProductStock
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>ResultListProductStock</code>.
   * @alias module:model/ResultListProductStock
   * @class
   ...
   * @param results {Array.<module:model/ProductStock>} result list
  ...
  /**
   * Constructs a <code>ResultListProductStock</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ResultListProductStock} obj Optional instance to populate.
   * @return {module:model/ResultListProductStock} The populated <code>ResultListProductStock</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results')) {
        obj['results'] = ApiClient.convertToType(data['results'], [ProductStock]);
      }
  ...
  /**
   * result list
   * @member {Array.<module:model/ProductStock>} results
   */
