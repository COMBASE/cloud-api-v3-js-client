...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Assortment'], factory);
  ...
  /**
   * The ResultListAssortment model module.
   * @module model/ResultListAssortment
   * @version 3
   */

  /**
   * Constructs a new <code>ResultListAssortment</code>.
   * @alias module:model/ResultListAssortment
   * @class
   ...
   * @param results {Array.<module:model/Assortment>} result list
  ...
  /**
   * Constructs a <code>ResultListAssortment</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ResultListAssortment} obj Optional instance to populate.
   * @return {module:model/ResultListAssortment} The populated <code>ResultListAssortment</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results')) {
        obj['results'] = ApiClient.convertToType(data['results'], [Assortment]);
      }
  ...
  /**
   * result list
   * @member {Array.<module:model/Assortment>} results
   */
