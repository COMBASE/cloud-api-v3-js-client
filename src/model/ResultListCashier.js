...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Cashier'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Cashier'));
  } else {
    // Browser globals (root is window)
    if (!root.CloudApiV3JsClient) {
      root.CloudApiV3JsClient = {};
    }
    root.CloudApiV3JsClient.ResultListCashier = factory(root.CloudApiV3JsClient.ApiClient, root.CloudApiV3JsClient.Cashier);
  }
}(this, function(ApiClient, Cashier) {
  'use strict';
  ...
  /**
   * The ResultListCashier model module.
   * @module model/ResultListCashier
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>ResultListCashier</code>.
   * @alias module:model/ResultListCashier
   * @class
   ...
   * @param results {Array.<module:model/Cashier>} result list
  ...
  /**
   * Constructs a <code>ResultListCashier</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ResultListCashier} obj Optional instance to populate.
   * @return {module:model/ResultListCashier} The populated <code>ResultListCashier</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results')) {
        obj['results'] = ApiClient.convertToType(data['results'], [Cashier]);
      }
  ...
  /**
   * result list
   * @member {Array.<module:model/Cashier>} results
   */
