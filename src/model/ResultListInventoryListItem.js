...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InventoryListItem'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InventoryListItem'));
  } else {
    // Browser globals (root is window)
    if (!root.CloudApiV3JsClient) {
      root.CloudApiV3JsClient = {};
    }
    root.CloudApiV3JsClient.ResultListInventoryListItem = factory(root.CloudApiV3JsClient.ApiClient, root.CloudApiV3JsClient.InventoryListItem);
  }
}(this, function(ApiClient, InventoryListItem) {
  'use strict';
  ...
  /**
   * The ResultListInventoryListItem model module.
   * @module model/ResultListInventoryListItem
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>ResultListInventoryListItem</code>.
   * @alias module:model/ResultListInventoryListItem
   * @class
   ...
   * @param results {Array.<module:model/InventoryListItem>} result list
  ...
  /**
   * Constructs a <code>ResultListInventoryListItem</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ResultListInventoryListItem} obj Optional instance to populate.
   * @return {module:model/ResultListInventoryListItem} The populated <code>ResultListInventoryListItem</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results')) {
        obj['results'] = ApiClient.convertToType(data['results'], [InventoryListItem]);
      }
  ...
  /**
   * result list
   * @member {Array.<module:model/InventoryListItem>} results
   */
