...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CloudApiV3JsClient.ResultListCustomer = factory(root.CloudApiV3JsClient.ApiClient, root.CloudApiV3JsClient.Customer);
  }
  ...
  /**
   * The ResultListCustomer model module.
   * @module model/ResultListCustomer
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>ResultListCustomer</code>.
   * @alias module:model/ResultListCustomer
   * @class
   ...
   * @param results {Array.<module:model/Customer>} result list
  ...
  /**
   * Constructs a <code>ResultListCustomer</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ResultListCustomer} obj Optional instance to populate.
   * @return {module:model/ResultListCustomer} The populated <code>ResultListCustomer</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results')) {
        obj['results'] = ApiClient.convertToType(data['results'], [Customer]);
      }
  ...
  /**
   * result list
   * @member {Array.<module:model/Customer>} results
   */
