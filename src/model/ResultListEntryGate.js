...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/EntryGate'], factory);
  ...
  /**
   * The ResultListEntryGate model module.
   * @module model/ResultListEntryGate
   * @version 3
   */

  /**
   * Constructs a new <code>ResultListEntryGate</code>.
   * @alias module:model/ResultListEntryGate
   * @class
   ...
   * @param results {Array.<module:model/EntryGate>} result list
  ...
  /**
   * Constructs a <code>ResultListEntryGate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ResultListEntryGate} obj Optional instance to populate.
   * @return {module:model/ResultListEntryGate} The populated <code>ResultListEntryGate</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results')) {
        obj['results'] = ApiClient.convertToType(data['results'], [EntryGate]);
      }
  ...
  /**
   * result list
   * @member {Array.<module:model/EntryGate>} results
   */
