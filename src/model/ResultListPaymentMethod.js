...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CloudApiV3JsClient.ResultListPaymentMethod = factory(root.CloudApiV3JsClient.ApiClient, root.CloudApiV3JsClient.PaymentMethod);
  }
  ...
  /**
   * The ResultListPaymentMethod model module.
   * @module model/ResultListPaymentMethod
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>ResultListPaymentMethod</code>.
   * @alias module:model/ResultListPaymentMethod
   * @class
   ...
   * @param results {Array.<module:model/PaymentMethod>} result list
  ...
  /**
   * Constructs a <code>ResultListPaymentMethod</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ResultListPaymentMethod} obj Optional instance to populate.
   * @return {module:model/ResultListPaymentMethod} The populated <code>ResultListPaymentMethod</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results')) {
        obj['results'] = ApiClient.convertToType(data['results'], [PaymentMethod]);
      }
  ...
  /**
   * result list
   * @member {Array.<module:model/PaymentMethod>} results
   */
