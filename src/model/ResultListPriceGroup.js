...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PriceGroup'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PriceGroup'));
  } else {
    // Browser globals (root is window)
    if (!root.CloudApiV3JsClient) {
      root.CloudApiV3JsClient = {};
    }
    root.CloudApiV3JsClient.ResultListPriceGroup = factory(root.CloudApiV3JsClient.ApiClient, root.CloudApiV3JsClient.PriceGroup);
  }
}(this, function(ApiClient, PriceGroup) {
  'use strict';
  ...
  /**
   * The ResultListPriceGroup model module.
   * @module model/ResultListPriceGroup
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>ResultListPriceGroup</code>.
   * @alias module:model/ResultListPriceGroup
   * @class
   ...
   * @param results {Array.<module:model/PriceGroup>} result list
  ...
  /**
   * Constructs a <code>ResultListPriceGroup</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ResultListPriceGroup} obj Optional instance to populate.
   * @return {module:model/ResultListPriceGroup} The populated <code>ResultListPriceGroup</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results')) {
        obj['results'] = ApiClient.convertToType(data['results'], [PriceGroup]);
      }
  ...
  /**
   * result list
   * @member {Array.<module:model/PriceGroup>} results
   */
