...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/EconomicZone'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./EconomicZone'));
  } else {
    // Browser globals (root is window)
    if (!root.CloudApiV3JsClient) {
      root.CloudApiV3JsClient = {};
    }
    root.CloudApiV3JsClient.ResultListEconomicZone = factory(root.CloudApiV3JsClient.ApiClient, root.CloudApiV3JsClient.EconomicZone);
  }
}(this, function(ApiClient, EconomicZone) {
  'use strict';
  ...
  /**
   * The ResultListEconomicZone model module.
   * @module model/ResultListEconomicZone
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>ResultListEconomicZone</code>.
   * @alias module:model/ResultListEconomicZone
   * @class
   ...
   * @param results {Array.<module:model/EconomicZone>} result list
  ...
  /**
   * Constructs a <code>ResultListEconomicZone</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ResultListEconomicZone} obj Optional instance to populate.
   * @return {module:model/ResultListEconomicZone} The populated <code>ResultListEconomicZone</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results')) {
        obj['results'] = ApiClient.convertToType(data['results'], [EconomicZone]);
      }
  ...
  /**
   * result list
   * @member {Array.<module:model/EconomicZone>} results
   */
