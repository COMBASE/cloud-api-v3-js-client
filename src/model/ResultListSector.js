...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Sector'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Sector'));
  } else {
    // Browser globals (root is window)
    if (!root.CloudApiV3JsClient) {
      root.CloudApiV3JsClient = {};
    }
    root.CloudApiV3JsClient.ResultListSector = factory(root.CloudApiV3JsClient.ApiClient, root.CloudApiV3JsClient.Sector);
  }
}(this, function(ApiClient, Sector) {
  'use strict';
  ...
  /**
   * The ResultListSector model module.
   * @module model/ResultListSector
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>ResultListSector</code>.
   * @alias module:model/ResultListSector
   * @class
   ...
   * @param results {Array.<module:model/Sector>} result list
  ...
  /**
   * Constructs a <code>ResultListSector</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ResultListSector} obj Optional instance to populate.
   * @return {module:model/ResultListSector} The populated <code>ResultListSector</code> instance.
   */
