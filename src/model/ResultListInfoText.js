...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InfoText'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InfoText'));
  } else {
    // Browser globals (root is window)
    if (!root.CloudApiV3JsClient) {
      root.CloudApiV3JsClient = {};
    }
    root.CloudApiV3JsClient.ResultListInfoText = factory(root.CloudApiV3JsClient.ApiClient, root.CloudApiV3JsClient.InfoText);
  }
}(this, function(ApiClient, InfoText) {
  'use strict';
  ...
  /**
   * The ResultListInfoText model module.
   * @module model/ResultListInfoText
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>ResultListInfoText</code>.
   * @alias module:model/ResultListInfoText
   * @class
   ...
   * @param results {Array.<module:model/InfoText>} result list
  ...
  /**
   * Constructs a <code>ResultListInfoText</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ResultListInfoText} obj Optional instance to populate.
   * @return {module:model/ResultListInfoText} The populated <code>ResultListInfoText</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results')) {
        obj['results'] = ApiClient.convertToType(data['results'], [InfoText]);
      }
  ...
  /**
   * result list
   * @member {Array.<module:model/InfoText>} results
   */
