...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Receipt'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Receipt'));
  } else {
    // Browser globals (root is window)
    if (!root.CloudApiV3JsClient) {
      root.CloudApiV3JsClient = {};
    }
    root.CloudApiV3JsClient.ResultListReceipt = factory(root.CloudApiV3JsClient.ApiClient, root.CloudApiV3JsClient.Receipt);
  }
}(this, function(ApiClient, Receipt) {
  'use strict';
  ...
  /**
   * The ResultListReceipt model module.
   * @module model/ResultListReceipt
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>ResultListReceipt</code>.
   * @alias module:model/ResultListReceipt
   * @class
   ...
   * @param results {Array.<module:model/Receipt>} result list
  ...
  /**
   * Constructs a <code>ResultListReceipt</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ResultListReceipt} obj Optional instance to populate.
   * @return {module:model/ResultListReceipt} The populated <code>ResultListReceipt</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results')) {
        obj['results'] = ApiClient.convertToType(data['results'], [Receipt]);
      }
  ...
  /**
   * result list
   * @member {Array.<module:model/Receipt>} results
   */
