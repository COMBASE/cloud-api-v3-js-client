...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/StockReceipt'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./StockReceipt'));
  } else {
    // Browser globals (root is window)
    if (!root.CloudApiV3JsClient) {
      root.CloudApiV3JsClient = {};
    }
    root.CloudApiV3JsClient.ResultListStockReceipt = factory(root.CloudApiV3JsClient.ApiClient, root.CloudApiV3JsClient.StockReceipt);
  }
}(this, function(ApiClient, StockReceipt) {
  'use strict';
  ...
  /**
   * The ResultListStockReceipt model module.
   * @module model/ResultListStockReceipt
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>ResultListStockReceipt</code>.
   * @alias module:model/ResultListStockReceipt
   * @class
   ...
   * @param results {Array.<module:model/StockReceipt>} result list
  ...
  /**
   * Constructs a <code>ResultListStockReceipt</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ResultListStockReceipt} obj Optional instance to populate.
   * @return {module:model/ResultListStockReceipt} The populated <code>ResultListStockReceipt</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results')) {
        obj['results'] = ApiClient.convertToType(data['results'], [StockReceipt]);
      }
  ...
  /**
   * result list
   * @member {Array.<module:model/StockReceipt>} results
   */
