...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/EndOfDayStatement'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./EndOfDayStatement'));
  } else {
    // Browser globals (root is window)
    if (!root.CloudApiV3JsClient) {
      root.CloudApiV3JsClient = {};
    }
    root.CloudApiV3JsClient.ResultListEndOfDayStatement = factory(root.CloudApiV3JsClient.ApiClient, root.CloudApiV3JsClient.EndOfDayStatement);
  }
}(this, function(ApiClient, EndOfDayStatement) {
  'use strict';
  ...
  /**
   * The ResultListEndOfDayStatement model module.
   * @module model/ResultListEndOfDayStatement
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>ResultListEndOfDayStatement</code>.
   * @alias module:model/ResultListEndOfDayStatement
   * @class
   ...
   * @param results {Array.<module:model/EndOfDayStatement>} result list
  ...
  /**
   * Constructs a <code>ResultListEndOfDayStatement</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ResultListEndOfDayStatement} obj Optional instance to populate.
   * @return {module:model/ResultListEndOfDayStatement} The populated <code>ResultListEndOfDayStatement</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results')) {
        obj['results'] = ApiClient.convertToType(data['results'], [EndOfDayStatement]);
      }
  ...
  /**
   * result list
   * @member {Array.<module:model/EndOfDayStatement>} results
   */
