...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AdditionalReceiptInfoType'], factory);
  ...
  /**
   * The ResultListAdditionalReceiptInfoType model module.
   * @module model/ResultListAdditionalReceiptInfoType
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>ResultListAdditionalReceiptInfoType</code>.
   * @alias module:model/ResultListAdditionalReceiptInfoType
   * @class
   ...
   * @param results {Array.<module:model/AdditionalReceiptInfoType>} result list
  ...
  /**
   * Constructs a <code>ResultListAdditionalReceiptInfoType</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ResultListAdditionalReceiptInfoType} obj Optional instance to populate.
   * @return {module:model/ResultListAdditionalReceiptInfoType} The populated <code>ResultListAdditionalReceiptInfoType</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results')) {
        obj['results'] = ApiClient.convertToType(data['results'], [AdditionalReceiptInfoType]);
      }
  ...
  /**
   * result list
   * @member {Array.<module:model/AdditionalReceiptInfoType>} results
   */
