...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CloudApiV3JsClient.CustomerGroupSummary = factory(root.CloudApiV3JsClient.ApiClient, root.CloudApiV3JsClient.ModelReference);
  }
  ...
  /**
   * The CustomerGroupSummary model module.
   * @module model/CustomerGroupSummary
   * @version 3.0.0
   */

  /**
   * Constructs a new <code>CustomerGroupSummary</code>.
   * @alias module:model/CustomerGroupSummary
   * @class
   */
  ...
  /**
   * Constructs a <code>CustomerGroupSummary</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CustomerGroupSummary} obj Optional instance to populate.
   * @return {module:model/CustomerGroupSummary} The populated <code>CustomerGroupSummary</code> instance.
   */
