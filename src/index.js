...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Account', 'model/AccountSummary', 'model/AccountTransaction', 'model/AddOrUpdateResult', 'model/AddressInformation', 'model/Admission', 'model/Amount', 'model/AmountCountData', 'model/Assortment', 'model/BadRequestError', 'model/Capacity', 'model/Cashier', 'model/CashierSummary', 'model/Category', 'model/CloudSubscription', 'model/CommodityGroupResource', 'model/CommodityGroupSummary', 'model/CompanyIdentification', 'model/Currency', 'model/CurrencyDenomination', 'model/CurrencyExchangeRate', 'model/Customer', 'model/CustomerCard', 'model/CustomerData', 'model/CustomerGroup', 'model/CustomerGroupSummary', 'model/CustomerInformation', 'model/CustomerOrder', 'model/DayRating', 'model/DeviceInformation', 'model/EconomicZone', 'model/EndOfDayStatement', 'model/EndOfDayStatementSummary', 'model/EntryGate', 'model/Event', 'model/ForbiddenError', 'model/GeoLocation', 'model/InfoText', 'model/Interval', 'model/Inventory', 'model/InventoryList', 'model/InventoryListItem', 'model/InventoryListItemStock', 'model/MethodNotAllowedError', 'model/ModelReference', 'model/NotFoundError', 'model/OrganizationalUnit', 'model/Payment', 'model/PaymentMethod', 'model/PaymentSummary', 'model/Period', 'model/PeriodListTopSeller', 'model/PeriodMapStringRevenueData', 'model/PeriodObject', 'model/PeriodRevenueData', 'model/Pos', 'model/PriceGroup', 'model/Product', 'model/ProductCode', 'model/ProductDescription', 'model/ProductPrice', 'model/ProductStock', 'model/ProductSubproduct', 'model/ProductSupplierPrice', 'model/ProductTransferInvolvedPartyInformation', 'model/ProductTransferInvolvedPartyInformationData', 'model/Rating', 'model/Receipt', 'model/ReceiptItem', 'model/ResultList', 'model/ResultListAssortment', 'model/ResultListCashier', 'model/ResultListCommodityGroupResource', 'model/ResultListCurrency', 'model/ResultListCustomer', 'model/ResultListCustomerGroup', 'model/ResultListCustomerOrder', 'model/ResultListDayRating', 'model/ResultListEconomicZone', 'model/ResultListEndOfDayStatement', 'model/ResultListEntryGate', 'model/ResultListEvent', 'model/ResultListInfoText', 'model/ResultListInventory', 'model/ResultListInventoryList', 'model/ResultListInventoryListItem', 'model/ResultListOrganizationalUnit', 'model/ResultListPaymentMethod', 'model/ResultListPos', 'model/ResultListPriceGroup', 'model/ResultListProduct', 'model/ResultListProductStock', 'model/ResultListReceipt', 'model/ResultListSalesTax', 'model/ResultListSector', 'model/ResultListStockReceipt', 'model/ResultListStockReceiptItem', 'model/ResultListSupplier', 'model/ResultListTag', 'model/ResultListTicketDefinition', 'model/RevenueData', 'model/SalesTax', 'model/SalesTaxRate', 'model/Sector', 'model/SectorSalesTaxItem', 'model/Statistic', 'model/StatisticListTopSeller', 'model/StatisticMapStringRevenueData', 'model/StatisticRevenueData', 'model/StockReceipt', 'model/StockReceiptItem', 'model/StockReceiptItemAmount', 'model/StockReceiptItemIdentification', 'model/StockReceiptItemPurchasePrice', 'model/Supplier', 'model/SupplierContact', 'model/SupplierContactPerson', 'model/SupplierPaymentInformation', 'model/Tag', 'model/TaxPayment', 'model/TaxSummary', 'model/TicketDefinition', 'model/TimePeriod', 'model/TooManyRequestsError', 'model/TopSeller', 'model/TotalPrice', 'model/Weather', 'api/AccountApi', 'api/AssortmentsApi', 'api/CashiersApi', 'api/CurrenciesApi', 'api/CustomerGroupsApi', 'api/CustomerOrdersApi', 'api/CustomersApi', 'api/EconomicZonesApi', 'api/ImagesApi', 'api/InfoTextsApi', 'api/InventoriesKORONARetailApi', 'api/OrganizationalUnitsApi', 'api/PaymentMethodsApi', 'api/PointsOfSaleApi', 'api/PriceGroupsApi', 'api/ProductsApi', 'api/SalesTaxesApi', 'api/SectorsApi', 'api/StatisticsApi', 'api/StockReceiptsKORONARetailApi', 'api/SuppliersApi', 'api/TagsApi', 'api/TicketingApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/Account'), require('./model/AccountSummary'), require('./model/AccountTransaction'), require('./model/AddOrUpdateResult'), require('./model/AddressInformation'), require('./model/Admission'), require('./model/Amount'), require('./model/AmountCountData'), require('./model/Assortment'), require('./model/BadRequestError'), require('./model/Capacity'), require('./model/Cashier'), require('./model/CashierSummary'), require('./model/Category'), require('./model/CloudSubscription'), require('./model/CommodityGroupResource'), require('./model/CommodityGroupSummary'), require('./model/CompanyIdentification'), require('./model/Currency'), require('./model/CurrencyDenomination'), require('./model/CurrencyExchangeRate'), require('./model/Customer'), require('./model/CustomerCard'), require('./model/CustomerData'), require('./model/CustomerGroup'), require('./model/CustomerGroupSummary'), require('./model/CustomerInformation'), require('./model/CustomerOrder'), require('./model/DayRating'), require('./model/DeviceInformation'), require('./model/EconomicZone'), require('./model/EndOfDayStatement'), require('./model/EndOfDayStatementSummary'), require('./model/EntryGate'), require('./model/Event'), require('./model/ForbiddenError'), require('./model/GeoLocation'), require('./model/InfoText'), require('./model/Interval'), require('./model/Inventory'), require('./model/InventoryList'), require('./model/InventoryListItem'), require('./model/InventoryListItemStock'), require('./model/MethodNotAllowedError'), require('./model/ModelReference'), require('./model/NotFoundError'), require('./model/OrganizationalUnit'), require('./model/Payment'), require('./model/PaymentMethod'), require('./model/PaymentSummary'), require('./model/Period'), require('./model/PeriodListTopSeller'), require('./model/PeriodMapStringRevenueData'), require('./model/PeriodObject'), require('./model/PeriodRevenueData'), require('./model/Pos'), require('./model/PriceGroup'), require('./model/Product'), require('./model/ProductCode'), require('./model/ProductDescription'), require('./model/ProductPrice'), require('./model/ProductStock'), require('./model/ProductSubproduct'), require('./model/ProductSupplierPrice'), require('./model/ProductTransferInvolvedPartyInformation'), require('./model/ProductTransferInvolvedPartyInformationData'), require('./model/Rating'), require('./model/Receipt'), require('./model/ReceiptItem'), require('./model/ResultList'), require('./model/ResultListAssortment'), require('./model/ResultListCashier'), require('./model/ResultListCommodityGroupResource'), require('./model/ResultListCurrency'), require('./model/ResultListCustomer'), require('./model/ResultListCustomerGroup'), require('./model/ResultListCustomerOrder'), require('./model/ResultListDayRating'), require('./model/ResultListEconomicZone'), require('./model/ResultListEndOfDayStatement'), require('./model/ResultListEntryGate'), require('./model/ResultListEvent'), require('./model/ResultListInfoText'), require('./model/ResultListInventory'), require('./model/ResultListInventoryList'), require('./model/ResultListInventoryListItem'), require('./model/ResultListOrganizationalUnit'), require('./model/ResultListPaymentMethod'), require('./model/ResultListPos'), require('./model/ResultListPriceGroup'), require('./model/ResultListProduct'), require('./model/ResultListProductStock'), require('./model/ResultListReceipt'), require('./model/ResultListSalesTax'), require('./model/ResultListSector'), require('./model/ResultListStockReceipt'), require('./model/ResultListStockReceiptItem'), require('./model/ResultListSupplier'), require('./model/ResultListTag'), require('./model/ResultListTicketDefinition'), require('./model/RevenueData'), require('./model/SalesTax'), require('./model/SalesTaxRate'), require('./model/Sector'), require('./model/SectorSalesTaxItem'), require('./model/Statistic'), require('./model/StatisticListTopSeller'), require('./model/StatisticMapStringRevenueData'), require('./model/StatisticRevenueData'), require('./model/StockReceipt'), require('./model/StockReceiptItem'), require('./model/StockReceiptItemAmount'), require('./model/StockReceiptItemIdentification'), require('./model/StockReceiptItemPurchasePrice'), require('./model/Supplier'), require('./model/SupplierContact'), require('./model/SupplierContactPerson'), require('./model/SupplierPaymentInformation'), require('./model/Tag'), require('./model/TaxPayment'), require('./model/TaxSummary'), require('./model/TicketDefinition'), require('./model/TimePeriod'), require('./model/TooManyRequestsError'), require('./model/TopSeller'), require('./model/TotalPrice'), require('./model/Weather'), require('./api/AccountApi'), require('./api/AssortmentsApi'), require('./api/CashiersApi'), require('./api/CurrenciesApi'), require('./api/CustomerGroupsApi'), require('./api/CustomerOrdersApi'), require('./api/CustomersApi'), require('./api/EconomicZonesApi'), require('./api/ImagesApi'), require('./api/InfoTextsApi'), require('./api/InventoriesKORONARetailApi'), require('./api/OrganizationalUnitsApi'), require('./api/PaymentMethodsApi'), require('./api/PointsOfSaleApi'), require('./api/PriceGroupsApi'), require('./api/ProductsApi'), require('./api/SalesTaxesApi'), require('./api/SectorsApi'), require('./api/StatisticsApi'), require('./api/StockReceiptsKORONARetailApi'), require('./api/SuppliersApi'), require('./api/TagsApi'), require('./api/TicketingApi'));
  }
}(function(ApiClient, Account, AccountSummary, AccountTransaction, AddOrUpdateResult, AddressInformation, Admission, Amount, AmountCountData, Assortment, BadRequestError, Capacity, Cashier, CashierSummary, Category, CloudSubscription, CommodityGroupResource, CommodityGroupSummary, CompanyIdentification, Currency, CurrencyDenomination, CurrencyExchangeRate, Customer, CustomerCard, CustomerData, CustomerGroup, CustomerGroupSummary, CustomerInformation, CustomerOrder, DayRating, DeviceInformation, EconomicZone, EndOfDayStatement, EndOfDayStatementSummary, EntryGate, Event, ForbiddenError, GeoLocation, InfoText, Interval, Inventory, InventoryList, InventoryListItem, InventoryListItemStock, MethodNotAllowedError, ModelReference, NotFoundError, OrganizationalUnit, Payment, PaymentMethod, PaymentSummary, Period, PeriodListTopSeller, PeriodMapStringRevenueData, PeriodObject, PeriodRevenueData, Pos, PriceGroup, Product, ProductCode, ProductDescription, ProductPrice, ProductStock, ProductSubproduct, ProductSupplierPrice, ProductTransferInvolvedPartyInformation, ProductTransferInvolvedPartyInformationData, Rating, Receipt, ReceiptItem, ResultList, ResultListAssortment, ResultListCashier, ResultListCommodityGroupResource, ResultListCurrency, ResultListCustomer, ResultListCustomerGroup, ResultListCustomerOrder, ResultListDayRating, ResultListEconomicZone, ResultListEndOfDayStatement, ResultListEntryGate, ResultListEvent, ResultListInfoText, ResultListInventory, ResultListInventoryList, ResultListInventoryListItem, ResultListOrganizationalUnit, ResultListPaymentMethod, ResultListPos, ResultListPriceGroup, ResultListProduct, ResultListProductStock, ResultListReceipt, ResultListSalesTax, ResultListSector, ResultListStockReceipt, ResultListStockReceiptItem, ResultListSupplier, ResultListTag, ResultListTicketDefinition, RevenueData, SalesTax, SalesTaxRate, Sector, SectorSalesTaxItem, Statistic, StatisticListTopSeller, StatisticMapStringRevenueData, StatisticRevenueData, StockReceipt, StockReceiptItem, StockReceiptItemAmount, StockReceiptItemIdentification, StockReceiptItemPurchasePrice, Supplier, SupplierContact, SupplierContactPerson, SupplierPaymentInformation, Tag, TaxPayment, TaxSummary, TicketDefinition, TimePeriod, TooManyRequestsError, TopSeller, TotalPrice, Weather, AccountApi, AssortmentsApi, CashiersApi, CurrenciesApi, CustomerGroupsApi, CustomerOrdersApi, CustomersApi, EconomicZonesApi, ImagesApi, InfoTextsApi, InventoriesKORONARetailApi, OrganizationalUnitsApi, PaymentMethodsApi, PointsOfSaleApi, PriceGroupsApi, ProductsApi, SalesTaxesApi, SectorsApi, StatisticsApi, StockReceiptsKORONARetailApi, SuppliersApi, TagsApi, TicketingApi) {
  'use strict';
  ...
  var exports = {
    ...
    /**
     * The CommodityGroupResource model constructor.
     * @property {module:model/CommodityGroupResource}
     */
    CommodityGroupResource: CommodityGroupResource,
    /**
    ...
    /**
     * The ResultListCommodityGroupResource model constructor.
     * @property {module:model/ResultListCommodityGroupResource}
     */
    ResultListCommodityGroupResource: ResultListCommodityGroupResource,
    /**
    ...
    /**
     * The InventoriesKORONARetailApi service constructor.
     * @property {module:api/InventoriesKORONARetailApi}
     */
    InventoriesKORONARetailApi: InventoriesKORONARetailApi,
    /**
    ...
    /**
     * The StockReceiptsKORONARetailApi service constructor.
     * @property {module:api/StockReceiptsKORONARetailApi}
     */
    StockReceiptsKORONARetailApi: StockReceiptsKORONARetailApi,
    /**
