...
(function(root, factory) {
   ...
   * @module cloud-api-v3-js-client/PaymentMethodsApi
   * @version 3.0.0
   */

  /**
   * Constructs a new PaymentMethodsApi. 
   * @alias module:cloud-api-v3-js-client/PaymentMethodsApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:cloud-api-v3-js-client/PaymentMethodsApi~getPaymentMethodCallback
     ...
     * @param {module:cloud-api-v3-js-client/PaymentMethodsApi~getPaymentMethodCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:cloud-api-v3-js-client/PaymentMethodsApi~getPaymentMethodsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:cloud-api-v3-js-client/PaymentMethodsApi~getPaymentMethodsCallback} callback The callback function, accepting three arguments: error, data, response
