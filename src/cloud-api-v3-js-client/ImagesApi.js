...
(function(root, factory) {
  ...
  /**
   * Images service.
   * @module cloud-api-v3-js-client/ImagesApi
   * @version 3.0.0
   */

  /**
   * Constructs a new ImagesApi. 
   * @alias module:cloud-api-v3-js-client/ImagesApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:cloud-api-v3-js-client/ImagesApi~getImageCallback
     ...
     * @param {module:cloud-api-v3-js-client/ImagesApi~getImageCallback} callback The callback function, accepting three arguments: error, data, response
     */
