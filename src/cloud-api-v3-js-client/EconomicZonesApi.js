...
(function(root, factory) {
   ...
   * @module cloud-api-v3-js-client/EconomicZonesApi
   * @version 3.0.0
   */

  /**
   * Constructs a new EconomicZonesApi. 
   * @alias module:cloud-api-v3-js-client/EconomicZonesApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:cloud-api-v3-js-client/EconomicZonesApi~getEconomicZoneCallback
     ...
     * @param {module:cloud-api-v3-js-client/EconomicZonesApi~getEconomicZoneCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:cloud-api-v3-js-client/EconomicZonesApi~getEconomicZonesCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:cloud-api-v3-js-client/EconomicZonesApi~getEconomicZonesCallback} callback The callback function, accepting three arguments: error, data, response
