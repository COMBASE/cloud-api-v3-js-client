...
(function(root, factory) {
  ...
  /**
   * SalesTaxes service.
   * @module cloud-api-v3-js-client/SalesTaxesApi
   * @version 3.0.0
   */

  /**
   * Constructs a new SalesTaxesApi. 
   * @alias module:cloud-api-v3-js-client/SalesTaxesApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:cloud-api-v3-js-client/SalesTaxesApi~getSalesTaxCallback
     ...
     * @param {module:cloud-api-v3-js-client/SalesTaxesApi~getSalesTaxCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:cloud-api-v3-js-client/SalesTaxesApi~getSalesTaxesCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:cloud-api-v3-js-client/SalesTaxesApi~getSalesTaxesCallback} callback The callback function, accepting three arguments: error, data, response
