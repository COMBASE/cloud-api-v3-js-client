...
(function(root, factory) {
  ...
  /**
   * Currencies service.
   * @module cloud-api-v3-js-client/CurrenciesApi
   * @version 3.0.0
   */

  /**
   * Constructs a new CurrenciesApi. 
   * @alias module:cloud-api-v3-js-client/CurrenciesApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:cloud-api-v3-js-client/CurrenciesApi~getCurrenciesCallback
     ...
     * @param {module:cloud-api-v3-js-client/CurrenciesApi~getCurrenciesCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:cloud-api-v3-js-client/CurrenciesApi~getCurrencyCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} koronaAccountId account id of the korona.cloud account
     * @param {module:cloud-api-v3-js-client/CurrenciesApi~getCurrencyCallback} callback The callback function, accepting three arguments: error, data, response
