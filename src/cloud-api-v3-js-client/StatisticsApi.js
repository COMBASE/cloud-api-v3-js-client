...
(function(root, factory) {
  ...
  /**
   * Statistics service.
   * @module cloud-api-v3-js-client/StatisticsApi
   * @version 3.0.0
   */

  /**
   * Constructs a new StatisticsApi. 
   * @alias module:cloud-api-v3-js-client/StatisticsApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:cloud-api-v3-js-client/StatisticsApi~getRevenueCallback
     ...
     * @param {module:cloud-api-v3-js-client/StatisticsApi~getRevenueCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:cloud-api-v3-js-client/StatisticsApi~getRevenueForCustomerGroupsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} opts.organizationalUnit number of the organizational unit
     * @param {module:model/String} opts.period time period for comparison
     * @param {module:cloud-api-v3-js-client/StatisticsApi~getRevenueForCustomerGroupsCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:cloud-api-v3-js-client/StatisticsApi~getRevenueHourlyCallback
     * @param {String} error Error message, if any.
     * @param {module:model/StatisticMapStringRevenueData} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.organizationalUnit number of the organizational unit
     * @param {module:model/String} opts.period time period for comparison
     * @param {module:cloud-api-v3-js-client/StatisticsApi~getRevenueHourlyCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/StatisticMapStringRevenueData}
     */
     ...
     * @callback module:cloud-api-v3-js-client/StatisticsApi~getTopSellerCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:cloud-api-v3-js-client/StatisticsApi~getTopSellerCallback} callback The callback function, accepting three arguments: error, data, response
