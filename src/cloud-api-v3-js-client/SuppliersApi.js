...
(function(root, factory) {
  ...
  /**
   * Suppliers service.
   * @module cloud-api-v3-js-client/SuppliersApi
   * @version 3.0.0
   */

  /**
   * Constructs a new SuppliersApi. 
   * @alias module:cloud-api-v3-js-client/SuppliersApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:cloud-api-v3-js-client/SuppliersApi~getSupplierCallback
     ...
     * @param {module:cloud-api-v3-js-client/SuppliersApi~getSupplierCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:cloud-api-v3-js-client/SuppliersApi~getSuppliersCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:cloud-api-v3-js-client/SuppliersApi~getSuppliersCallback} callback The callback function, accepting three arguments: error, data, response
