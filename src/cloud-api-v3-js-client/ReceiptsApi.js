...
(function(root, factory) {
  ...
  /**
   * Receipts service.
   * @module cloud-api-v3-js-client/ReceiptsApi
   * @version 3.0.0
   */

  /**
   * Constructs a new ReceiptsApi. 
   * @alias module:cloud-api-v3-js-client/ReceiptsApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:cloud-api-v3-js-client/ReceiptsApi~getReceiptCallback
     ...
     * @param {module:cloud-api-v3-js-client/ReceiptsApi~getReceiptCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:cloud-api-v3-js-client/ReceiptsApi~getReceiptsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:cloud-api-v3-js-client/ReceiptsApi~getReceiptsCallback} callback The callback function, accepting three arguments: error, data, response
