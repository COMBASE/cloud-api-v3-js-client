...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} infoTextIdOrNumber id or number of the related object (important: if a number should match the uuid-format, the system will lookup for an id instead of a number)
     ...
     */
    this.getInfoText = function(accountId, infoTextIdOrNumber, callback) {
      var postBody = null;

      // verify the required parameter 'accountId' is set
      if (accountId === undefined || accountId === null) {
        throw new Error("Missing the required parameter 'accountId' when calling getInfoText");
      }

      // verify the required parameter 'infoTextIdOrNumber' is set
      if (infoTextIdOrNumber === undefined || infoTextIdOrNumber === null) {
        throw new Error("Missing the required parameter 'infoTextIdOrNumber' when calling getInfoText");
      }


      var pathParams = {
        'accountId': accountId,
        'infoTextIdOrNumber': infoTextIdOrNumber
      };
      var queryParams = {
      };
      ...
      return this.apiClient.callApi(
        '/accounts/{accountId}/infoTexts/{infoTextIdOrNumber}', 'GET',
     ...
     */
    this.getInfoTexts = function(accountId, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'accountId' is set
      if (accountId === undefined || accountId === null) {
        throw new Error("Missing the required parameter 'accountId' when calling getInfoTexts");
      }
      ...
      return this.apiClient.callApi(
        '/accounts/{accountId}/infoTexts', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
