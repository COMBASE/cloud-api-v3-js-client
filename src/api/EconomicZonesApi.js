...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} economicZoneIdOrNumber id or number of the related object (important: if a number should match the uuid-format, the system will lookup for an id instead of a number)
     ...
     */
    this.getEconomicZone = function(accountId, economicZoneIdOrNumber, callback) {
      var postBody = null;

      // verify the required parameter 'accountId' is set
      if (accountId === undefined || accountId === null) {
        throw new Error("Missing the required parameter 'accountId' when calling getEconomicZone");
      }

      // verify the required parameter 'economicZoneIdOrNumber' is set
      if (economicZoneIdOrNumber === undefined || economicZoneIdOrNumber === null) {
        throw new Error("Missing the required parameter 'economicZoneIdOrNumber' when calling getEconomicZone");
      }


      var pathParams = {
        'accountId': accountId,
        'economicZoneIdOrNumber': economicZoneIdOrNumber
      };
      var queryParams = {
      };
      ...
      return this.apiClient.callApi(
        '/accounts/{accountId}/economicZones/{economicZoneIdOrNumber}', 'GET',
     ...
     */
    this.getEconomicZones = function(accountId, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'accountId' is set
      if (accountId === undefined || accountId === null) {
        throw new Error("Missing the required parameter 'accountId' when calling getEconomicZones");
      }
      ...
      return this.apiClient.callApi(
        '/accounts/{accountId}/economicZones', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
