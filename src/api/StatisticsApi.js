...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     */
    this.getRevenue = function(accountId, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'accountId' is set
      if (accountId === undefined || accountId === null) {
        throw new Error("Missing the required parameter 'accountId' when calling getRevenue");
      }
      ...
      return this.apiClient.callApi(
        '/accounts/{accountId}/statistics/revenueData', 'GET',
     ...
     */
    this.getRevenueForCustomerGroups = function(accountId, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'accountId' is set
      if (accountId === undefined || accountId === null) {
        throw new Error("Missing the required parameter 'accountId' when calling getRevenueForCustomerGroups");
      }
      ...
      return this.apiClient.callApi(
        '/accounts/{accountId}/statistics/revenueDataForCustomerGroups', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
     ...
     * data is of type: {@link module:model/StatisticMapStringRevenueData}
     */
    this.getRevenueHourly = function(accountId, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'accountId' is set
      if (accountId === undefined || accountId === null) {
        throw new Error("Missing the required parameter 'accountId' when calling getRevenueHourly");
      }
      ...
      return this.apiClient.callApi(
        '/accounts/{accountId}/statistics/revenueDataHourly', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
     ...
     */
    this.getTopSeller = function(accountId, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'accountId' is set
      if (accountId === undefined || accountId === null) {
        throw new Error("Missing the required parameter 'accountId' when calling getTopSeller");
      }
      ...
      return this.apiClient.callApi(
        '/accounts/{accountId}/statistics/topSeller', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
