...
(function(root, factory) {
  ...
  /**
   * PriceGroups service.
   * @module api/PriceGroupsApi
   * @version 3
   */

  /**
   * Constructs a new PriceGroupsApi. 
   * @alias module:api/PriceGroupsApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/PriceGroupsApi~getPriceGroupCallback
     ...
     * @param {String} priceGroupIdOrNumber id or number of the related object (important: if a number should match the uuid-format, the system will lookup for an id instead of a number)
     * @param {module:api/PriceGroupsApi~getPriceGroupCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PriceGroup}
     */
    this.getPriceGroup = function(accountId, priceGroupIdOrNumber, callback) {
      var postBody = null;

      // verify the required parameter 'accountId' is set
      if (accountId === undefined || accountId === null) {
        throw new Error("Missing the required parameter 'accountId' when calling getPriceGroup");
      }

      // verify the required parameter 'priceGroupIdOrNumber' is set
      if (priceGroupIdOrNumber === undefined || priceGroupIdOrNumber === null) {
        throw new Error("Missing the required parameter 'priceGroupIdOrNumber' when calling getPriceGroup");
      }


      var pathParams = {
        'accountId': accountId,
        'priceGroupIdOrNumber': priceGroupIdOrNumber
      };
      var queryParams = {
      };
      ...
      return this.apiClient.callApi(
        '/accounts/{accountId}/priceGroups/{priceGroupIdOrNumber}', 'GET',
     ...
     * @callback module:api/PriceGroupsApi~getPriceGroupsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/PriceGroupsApi~getPriceGroupsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ResultListPriceGroup}
     */
    this.getPriceGroups = function(accountId, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'accountId' is set
      if (accountId === undefined || accountId === null) {
        throw new Error("Missing the required parameter 'accountId' when calling getPriceGroups");
      }
      ...
      return this.apiClient.callApi(
        '/accounts/{accountId}/priceGroups', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
