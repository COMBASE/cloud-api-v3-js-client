...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} supplierIdOrNumber id or number of the related object (important: if a number should match the uuid-format, the system will lookup for an id instead of a number)
     ...
     */
    this.getSupplier = function(accountId, supplierIdOrNumber, callback) {
      var postBody = null;

      // verify the required parameter 'accountId' is set
      if (accountId === undefined || accountId === null) {
        throw new Error("Missing the required parameter 'accountId' when calling getSupplier");
      }
      ...
      return this.apiClient.callApi(
        '/accounts/{accountId}/suppliers/{supplierIdOrNumber}', 'GET',
     ...
     */
    this.getSuppliers = function(accountId, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'accountId' is set
      if (accountId === undefined || accountId === null) {
        throw new Error("Missing the required parameter 'accountId' when calling getSuppliers");
      }
      ...
      return this.apiClient.callApi(
        '/accounts/{accountId}/suppliers', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
