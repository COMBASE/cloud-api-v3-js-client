...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} tagId id or number of the related object (important: if a number should match the uuid-format, the system will lookup for an id instead of a number)
     ...
     */
    this.getTag = function(accountId, tagId, callback) {
      var postBody = null;

      // verify the required parameter 'accountId' is set
      if (accountId === undefined || accountId === null) {
        throw new Error("Missing the required parameter 'accountId' when calling getTag");
      }
      ...
      return this.apiClient.callApi(
        '/accounts/{accountId}/tags/{tagId}', 'GET',
     ...
     */
    this.getTags = function(accountId, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'accountId' is set
      if (accountId === undefined || accountId === null) {
        throw new Error("Missing the required parameter 'accountId' when calling getTags");
      }
