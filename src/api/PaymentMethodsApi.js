...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} paymentMethodIdOrNumber id or number of the related object (important: if a number should match the uuid-format, the system will lookup for an id instead of a number)
     ...
     */
    this.getPaymentMethod = function(accountId, paymentMethodIdOrNumber, callback) {
      var postBody = null;
      ...
      // verify the required parameter 'paymentMethodIdOrNumber' is set
      if (paymentMethodIdOrNumber === undefined || paymentMethodIdOrNumber === null) {
        throw new Error("Missing the required parameter 'paymentMethodIdOrNumber' when calling getPaymentMethod");
      }


      var pathParams = {
        'accountId': accountId,
        'paymentMethodIdOrNumber': paymentMethodIdOrNumber
      };
      var queryParams = {
      };
      ...
      return this.apiClient.callApi(
        '/accounts/{accountId}/paymentMethods/{paymentMethodIdOrNumber}', 'GET',
     ...
     */
    this.getPaymentMethods = function(accountId, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'accountId' is set
      if (accountId === undefined || accountId === null) {
        throw new Error("Missing the required parameter 'accountId' when calling getPaymentMethods");
      }
      ...
      return this.apiClient.callApi(
        '/accounts/{accountId}/paymentMethods', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
