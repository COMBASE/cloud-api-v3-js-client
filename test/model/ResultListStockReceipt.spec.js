...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KoronacloudApiV3.ResultListStockReceipt();
  });
  ...
  describe('ResultListStockReceipt', function() {
    it('should create an instance of ResultListStockReceipt', function() {
      // uncomment below and update the code to test ResultListStockReceipt
      //var instane = new KoronacloudApiV3.ResultListStockReceipt();
      //expect(instance).to.be.a(KoronacloudApiV3.ResultListStockReceipt);
    });
