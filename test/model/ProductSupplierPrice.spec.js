...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KoronacloudApiV3.ProductSupplierPrice();
  });
  ...
  describe('ProductSupplierPrice', function() {
    it('should create an instance of ProductSupplierPrice', function() {
      // uncomment below and update the code to test ProductSupplierPrice
      //var instane = new KoronacloudApiV3.ProductSupplierPrice();
      //expect(instance).to.be.a(KoronacloudApiV3.ProductSupplierPrice);
    });
