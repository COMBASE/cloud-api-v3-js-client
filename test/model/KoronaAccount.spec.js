...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KoronacloudApiV3.KoronaAccount();
  });
  ...
  describe('KoronaAccount', function() {
    it('should create an instance of KoronaAccount', function() {
      // uncomment below and update the code to test KoronaAccount
      //var instane = new KoronacloudApiV3.KoronaAccount();
      //expect(instance).to.be.a(KoronacloudApiV3.KoronaAccount);
    });
    ...
    it('should have the property cloudSubscription (base name: "cloudSubscription")', function() {
      // uncomment below and update the code to test the property cloudSubscription
      //var instane = new KoronacloudApiV3.KoronaAccount();
      //expect(instance).to.be();
    });
