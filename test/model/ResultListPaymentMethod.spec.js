...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KoronacloudApiV3.ResultListPaymentMethod();
  });
  ...
  describe('ResultListPaymentMethod', function() {
    it('should create an instance of ResultListPaymentMethod', function() {
      // uncomment below and update the code to test ResultListPaymentMethod
      //var instane = new KoronacloudApiV3.ResultListPaymentMethod();
      //expect(instance).to.be.a(KoronacloudApiV3.ResultListPaymentMethod);
    });
