...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KoronacloudApiV3.ResultListInventoryList();
  });
  ...
  describe('ResultListInventoryList', function() {
    it('should create an instance of ResultListInventoryList', function() {
      // uncomment below and update the code to test ResultListInventoryList
      //var instane = new KoronacloudApiV3.ResultListInventoryList();
      //expect(instance).to.be.a(KoronacloudApiV3.ResultListInventoryList);
    });
