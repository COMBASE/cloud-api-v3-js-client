...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KoronacloudApiV3.ResultListCustomer();
  });
  ...
  describe('ResultListCustomer', function() {
    it('should create an instance of ResultListCustomer', function() {
      // uncomment below and update the code to test ResultListCustomer
      //var instane = new KoronacloudApiV3.ResultListCustomer();
      //expect(instance).to.be.a(KoronacloudApiV3.ResultListCustomer);
    });
