...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KoronacloudApiV3.ResultListAdditionalReceiptInfoType();
  });
  ...
  describe('ResultListAdditionalReceiptInfoType', function() {
    it('should create an instance of ResultListAdditionalReceiptInfoType', function() {
      // uncomment below and update the code to test ResultListAdditionalReceiptInfoType
      //var instane = new KoronacloudApiV3.ResultListAdditionalReceiptInfoType();
      //expect(instance).to.be.a(KoronacloudApiV3.ResultListAdditionalReceiptInfoType);
    });
