...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KoronacloudApiV3.ResultListCurrency();
  });
  ...
  describe('ResultListCurrency', function() {
    it('should create an instance of ResultListCurrency', function() {
      // uncomment below and update the code to test ResultListCurrency
      //var instane = new KoronacloudApiV3.ResultListCurrency();
      //expect(instance).to.be.a(KoronacloudApiV3.ResultListCurrency);
    });
