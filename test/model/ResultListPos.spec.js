...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KoronacloudApiV3.ResultListPos();
  });
  ...
  describe('ResultListPos', function() {
    it('should create an instance of ResultListPos', function() {
      // uncomment below and update the code to test ResultListPos
      //var instane = new KoronacloudApiV3.ResultListPos();
      //expect(instance).to.be.a(KoronacloudApiV3.ResultListPos);
    });
