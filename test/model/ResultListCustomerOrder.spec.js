...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KoronacloudApiV3.ResultListCustomerOrder();
  });
  ...
  describe('ResultListCustomerOrder', function() {
    it('should create an instance of ResultListCustomerOrder', function() {
      // uncomment below and update the code to test ResultListCustomerOrder
      //var instane = new KoronacloudApiV3.ResultListCustomerOrder();
      //expect(instance).to.be.a(KoronacloudApiV3.ResultListCustomerOrder);
    });
