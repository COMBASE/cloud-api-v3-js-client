...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KoronacloudApiV3.ResultListSector();
  });
  ...
  describe('ResultListSector', function() {
    it('should create an instance of ResultListSector', function() {
      // uncomment below and update the code to test ResultListSector
      //var instane = new KoronacloudApiV3.ResultListSector();
      //expect(instance).to.be.a(KoronacloudApiV3.ResultListSector);
    });
