...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KoronacloudApiV3.ResultListAssortment();
  });
  ...
  describe('ResultListAssortment', function() {
    it('should create an instance of ResultListAssortment', function() {
      // uncomment below and update the code to test ResultListAssortment
      //var instane = new KoronacloudApiV3.ResultListAssortment();
      //expect(instance).to.be.a(KoronacloudApiV3.ResultListAssortment);
    });
