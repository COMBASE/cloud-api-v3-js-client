...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KoronacloudApiV3.ResultListDayRating();
  });
  ...
  describe('ResultListDayRating', function() {
    it('should create an instance of ResultListDayRating', function() {
      // uncomment below and update the code to test ResultListDayRating
      //var instane = new KoronacloudApiV3.ResultListDayRating();
      //expect(instance).to.be.a(KoronacloudApiV3.ResultListDayRating);
    });
