...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KoronacloudApiV3.ResultListProductStock();
  });
  ...
  describe('ResultListProductStock', function() {
    it('should create an instance of ResultListProductStock', function() {
      // uncomment below and update the code to test ResultListProductStock
      //var instane = new KoronacloudApiV3.ResultListProductStock();
      //expect(instance).to.be.a(KoronacloudApiV3.ResultListProductStock);
    });
