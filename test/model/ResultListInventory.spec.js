...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KoronacloudApiV3.ResultListInventory();
  });
  ...
  describe('ResultListInventory', function() {
    it('should create an instance of ResultListInventory', function() {
      // uncomment below and update the code to test ResultListInventory
      //var instane = new KoronacloudApiV3.ResultListInventory();
      //expect(instance).to.be.a(KoronacloudApiV3.ResultListInventory);
    });
