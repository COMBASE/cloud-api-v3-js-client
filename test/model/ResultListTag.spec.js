...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KoronacloudApiV3.ResultListTag();
  });
  ...
  describe('ResultListTag', function() {
    it('should create an instance of ResultListTag', function() {
      // uncomment below and update the code to test ResultListTag
      //var instane = new KoronacloudApiV3.ResultListTag();
      //expect(instance).to.be.a(KoronacloudApiV3.ResultListTag);
    });
