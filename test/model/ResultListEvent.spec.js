...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KoronacloudApiV3.ResultListEvent();
  });
  ...
  describe('ResultListEvent', function() {
    it('should create an instance of ResultListEvent', function() {
      // uncomment below and update the code to test ResultListEvent
      //var instane = new KoronacloudApiV3.ResultListEvent();
      //expect(instance).to.be.a(KoronacloudApiV3.ResultListEvent);
    });
