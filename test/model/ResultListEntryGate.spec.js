...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KoronacloudApiV3.ResultListEntryGate();
  });
  ...
  describe('ResultListEntryGate', function() {
    it('should create an instance of ResultListEntryGate', function() {
      // uncomment below and update the code to test ResultListEntryGate
      //var instane = new KoronacloudApiV3.ResultListEntryGate();
      //expect(instance).to.be.a(KoronacloudApiV3.ResultListEntryGate);
    });
