...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KoronacloudApiV3.ResultListAccount();
  });
  ...
  describe('ResultListAccount', function() {
    it('should create an instance of ResultListAccount', function() {
      // uncomment below and update the code to test ResultListAccount
      //var instane = new KoronacloudApiV3.ResultListAccount();
      //expect(instance).to.be.a(KoronacloudApiV3.ResultListAccount);
    });
