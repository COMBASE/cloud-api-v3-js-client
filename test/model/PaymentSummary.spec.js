...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KoronacloudApiV3.PaymentSummary();
  });
  ...
  describe('PaymentSummary', function() {
    it('should create an instance of PaymentSummary', function() {
      ...
      //var instane = new KoronacloudApiV3.PaymentSummary();
      //expect(instance).to.be.a(KoronacloudApiV3.PaymentSummary);
    });
    ...
    it('should have the property expectedAmount (base name: "expectedAmount")', function() {
