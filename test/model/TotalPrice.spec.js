...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KoronacloudApiV3.TotalPrice();
  });
  ...
  describe('TotalPrice', function() {
    it('should create an instance of TotalPrice', function() {
      ...
      //var instane = new KoronacloudApiV3.TotalPrice();
      //expect(instance).to.be.a(KoronacloudApiV3.TotalPrice);
    });
    ...
    it('should have the property taxPayments (base name: "taxPayments")', function() {
      // uncomment below and update the code to test the property taxPayments
      //var instane = new KoronacloudApiV3.TotalPrice();
      //expect(instance).to.be();
    });
