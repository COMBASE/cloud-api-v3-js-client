...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KoronacloudApiV3.ProductCode();
  });
  ...
  describe('ProductCode', function() {
    it('should create an instance of ProductCode', function() {
      // uncomment below and update the code to test ProductCode
      //var instane = new KoronacloudApiV3.ProductCode();
      //expect(instance).to.be.a(KoronacloudApiV3.ProductCode);
    });
