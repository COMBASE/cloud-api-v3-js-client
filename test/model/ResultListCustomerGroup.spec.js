...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KoronacloudApiV3.ResultListCustomerGroup();
  });
  ...
  describe('ResultListCustomerGroup', function() {
    it('should create an instance of ResultListCustomerGroup', function() {
      // uncomment below and update the code to test ResultListCustomerGroup
      //var instane = new KoronacloudApiV3.ResultListCustomerGroup();
      //expect(instance).to.be.a(KoronacloudApiV3.ResultListCustomerGroup);
    });
