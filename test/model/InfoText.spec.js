...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KoronacloudApiV3.InfoText();
  });
  ...
  describe('InfoText', function() {
    it('should create an instance of InfoText', function() {
      // uncomment below and update the code to test InfoText
      //var instane = new KoronacloudApiV3.InfoText();
      //expect(instance).to.be.a(KoronacloudApiV3.InfoText);
    });
