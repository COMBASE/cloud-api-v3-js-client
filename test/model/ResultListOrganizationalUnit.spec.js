...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KoronacloudApiV3.ResultListOrganizationalUnit();
  });
  ...
  describe('ResultListOrganizationalUnit', function() {
    it('should create an instance of ResultListOrganizationalUnit', function() {
      // uncomment below and update the code to test ResultListOrganizationalUnit
      //var instane = new KoronacloudApiV3.ResultListOrganizationalUnit();
      //expect(instance).to.be.a(KoronacloudApiV3.ResultListOrganizationalUnit);
    });
