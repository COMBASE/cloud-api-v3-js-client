...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KoronacloudApiV3.ResultListCommodityGroupResource();
  });
  ...
  describe('ResultListCommodityGroupResource', function() {
    it('should create an instance of ResultListCommodityGroupResource', function() {
      // uncomment below and update the code to test ResultListCommodityGroupResource
      //var instane = new KoronacloudApiV3.ResultListCommodityGroupResource();
      //expect(instance).to.be.a(KoronacloudApiV3.ResultListCommodityGroupResource);
    });
