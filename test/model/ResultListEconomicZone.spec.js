...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KoronacloudApiV3.ResultListEconomicZone();
  });
  ...
  describe('ResultListEconomicZone', function() {
    it('should create an instance of ResultListEconomicZone', function() {
      // uncomment below and update the code to test ResultListEconomicZone
      //var instane = new KoronacloudApiV3.ResultListEconomicZone();
      //expect(instance).to.be.a(KoronacloudApiV3.ResultListEconomicZone);
    });
