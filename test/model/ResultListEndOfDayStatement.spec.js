...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KoronacloudApiV3.ResultListEndOfDayStatement();
  });
  ...
  describe('ResultListEndOfDayStatement', function() {
    it('should create an instance of ResultListEndOfDayStatement', function() {
      // uncomment below and update the code to test ResultListEndOfDayStatement
      //var instane = new KoronacloudApiV3.ResultListEndOfDayStatement();
      //expect(instance).to.be.a(KoronacloudApiV3.ResultListEndOfDayStatement);
    });
