...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KoronacloudApiV3.ResultListCashier();
  });
  ...
  describe('ResultListCashier', function() {
    it('should create an instance of ResultListCashier', function() {
      // uncomment below and update the code to test ResultListCashier
      //var instane = new KoronacloudApiV3.ResultListCashier();
      //expect(instance).to.be.a(KoronacloudApiV3.ResultListCashier);
    });
