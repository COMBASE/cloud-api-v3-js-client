...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KoronacloudApiV3.ResultListReceipt();
  });
  ...
  describe('ResultListReceipt', function() {
    it('should create an instance of ResultListReceipt', function() {
      // uncomment below and update the code to test ResultListReceipt
      //var instane = new KoronacloudApiV3.ResultListReceipt();
      //expect(instance).to.be.a(KoronacloudApiV3.ResultListReceipt);
    });
