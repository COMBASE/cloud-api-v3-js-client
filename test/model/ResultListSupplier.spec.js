...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KoronacloudApiV3.ResultListSupplier();
  });
  ...
  describe('ResultListSupplier', function() {
    it('should create an instance of ResultListSupplier', function() {
      // uncomment below and update the code to test ResultListSupplier
      //var instane = new KoronacloudApiV3.ResultListSupplier();
      //expect(instance).to.be.a(KoronacloudApiV3.ResultListSupplier);
    });
