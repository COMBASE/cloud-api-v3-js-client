...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KoronacloudApiV3.SalesTaxRate();
  });
  ...
  describe('SalesTaxRate', function() {
    it('should create an instance of SalesTaxRate', function() {
      // uncomment below and update the code to test SalesTaxRate
      //var instane = new KoronacloudApiV3.SalesTaxRate();
      //expect(instance).to.be.a(KoronacloudApiV3.SalesTaxRate);
    });
