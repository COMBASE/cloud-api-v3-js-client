...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KoronacloudApiV3.ResultListTicketDefinition();
  });
  ...
  describe('ResultListTicketDefinition', function() {
    it('should create an instance of ResultListTicketDefinition', function() {
      // uncomment below and update the code to test ResultListTicketDefinition
      //var instane = new KoronacloudApiV3.ResultListTicketDefinition();
      //expect(instance).to.be.a(KoronacloudApiV3.ResultListTicketDefinition);
    });
