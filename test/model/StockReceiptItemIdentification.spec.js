...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KoronacloudApiV3.StockReceiptItemIdentification();
  });
  ...
  describe('StockReceiptItemIdentification', function() {
    it('should create an instance of StockReceiptItemIdentification', function() {
      // uncomment below and update the code to test StockReceiptItemIdentification
      //var instane = new KoronacloudApiV3.StockReceiptItemIdentification();
      //expect(instance).to.be.a(KoronacloudApiV3.StockReceiptItemIdentification);
    });
