...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KoronacloudApiV3.ResultListProduct();
  });
  ...
  describe('ResultListProduct', function() {
    it('should create an instance of ResultListProduct', function() {
      // uncomment below and update the code to test ResultListProduct
      //var instane = new KoronacloudApiV3.ResultListProduct();
      //expect(instance).to.be.a(KoronacloudApiV3.ResultListProduct);
    });
