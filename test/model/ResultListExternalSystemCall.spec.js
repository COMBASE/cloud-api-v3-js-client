...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KoronacloudApiV3.ResultListExternalSystemCall();
  });
  ...
  describe('ResultListExternalSystemCall', function() {
    it('should create an instance of ResultListExternalSystemCall', function() {
      // uncomment below and update the code to test ResultListExternalSystemCall
      //var instane = new KoronacloudApiV3.ResultListExternalSystemCall();
      //expect(instance).to.be.a(KoronacloudApiV3.ResultListExternalSystemCall);
    });
