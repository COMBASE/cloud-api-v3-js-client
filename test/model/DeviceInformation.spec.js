...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KoronacloudApiV3.DeviceInformation();
  });
  ...
  describe('DeviceInformation', function() {
    it('should create an instance of DeviceInformation', function() {
      // uncomment below and update the code to test DeviceInformation
      //var instane = new KoronacloudApiV3.DeviceInformation();
      //expect(instance).to.be.a(KoronacloudApiV3.DeviceInformation);
    });
