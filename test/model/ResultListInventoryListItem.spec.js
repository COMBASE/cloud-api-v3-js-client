...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KoronacloudApiV3.ResultListInventoryListItem();
  });
  ...
  describe('ResultListInventoryListItem', function() {
    it('should create an instance of ResultListInventoryListItem', function() {
      // uncomment below and update the code to test ResultListInventoryListItem
      //var instane = new KoronacloudApiV3.ResultListInventoryListItem();
      //expect(instance).to.be.a(KoronacloudApiV3.ResultListInventoryListItem);
    });
