...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KoronacloudApiV3.ResultListSalesTax();
  });
  ...
  describe('ResultListSalesTax', function() {
    it('should create an instance of ResultListSalesTax', function() {
      // uncomment below and update the code to test ResultListSalesTax
      //var instane = new KoronacloudApiV3.ResultListSalesTax();
      //expect(instance).to.be.a(KoronacloudApiV3.ResultListSalesTax);
    });
