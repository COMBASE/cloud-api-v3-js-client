...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KoronacloudApiV3.ResultListInfoText();
  });
  ...
  describe('ResultListInfoText', function() {
    it('should create an instance of ResultListInfoText', function() {
      // uncomment below and update the code to test ResultListInfoText
      //var instane = new KoronacloudApiV3.ResultListInfoText();
      //expect(instance).to.be.a(KoronacloudApiV3.ResultListInfoText);
    });
