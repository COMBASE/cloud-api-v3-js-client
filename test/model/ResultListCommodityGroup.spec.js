...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KoronacloudApiV3.ResultListCommodityGroup();
  });
  ...
  describe('ResultListCommodityGroup', function() {
    it('should create an instance of ResultListCommodityGroup', function() {
      // uncomment below and update the code to test ResultListCommodityGroup
      //var instane = new KoronacloudApiV3.ResultListCommodityGroup();
      //expect(instance).to.be.a(KoronacloudApiV3.ResultListCommodityGroup);
    });
